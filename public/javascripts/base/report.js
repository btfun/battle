(function(global,factory){
  ...
  'use strict';
     ...
     var jsErrorReport=function(params){
         ...
         //重写send方法,监控xhr请求
         var _ajaxListener = new Object();
         _ajaxListener.tempSend = XMLHttpRequest.prototype.send;//复制原先的send方法
         _ajaxListener.tempOpen= XMLHttpRequest.prototype.open;//复制原先的open方法
         //重写open方法,记录请求的url
         XMLHttpRequest.prototype.open = function(method,url,boolen){
             _ajaxListener.tempOpen.apply(this, [method,url,boolen]);
             this.ajaxUrl = url;

         };
         XMLHttpRequest.prototype.send = function(_data){
             _ajaxListener.tempSend.apply(this, [_data]);
