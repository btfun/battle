...
(function (global, factory, GLOBAL) {
    ...
    var confRoot = GLOBAL.confRoot || 'http://saas.mljia.cn/',
        //saas接口上下文
    wxRoot = GLOBAL.wxRoot || 'http://wx.mljia.cn/',
        // 微信接口
    myRoot = GLOBAL.myRoot || 'http://mall.mljia.cn/',
        //美业商城
    cometRoot = GLOBAL.cometRoot || 'http://comet.mljia.cn/',
        //长链接
    payRoot = GLOBAL.payRoot || 'http://pay.mljia.cn/',
        //支付
    smsRoot = GLOBAL.smsRoot || 'http://sell.mljia.cn/',
        //短信营销
